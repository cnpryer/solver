...
/// ```
fn find_shortest_path<T, U: Copy + Into<usize>>(
    graph: &Graph<T, U>,
    index: usize,
) -> Option<Vec<&T>> {
    unimplemented!()
...
/// ```
fn find_longest_path<T, U: Copy + Into<usize>>(
    graph: &Graph<T, U>,
    index: usize,
) -> Option<Vec<&T>> {
    unimplemented!()
...
/// ```
fn find_heaviest_path<T, U: Copy + Into<usize>>(
    graph: &Graph<T, U>,
    index: usize,
) -> Option<Vec<&T>> {
    unimplemented!()
...
/// ```
fn find_lighest_path<T, U: Copy + Into<usize>>(
    graph: &Graph<T, U>,
    index: usize,
) -> Option<Vec<&T>> {
    unimplemented!()
